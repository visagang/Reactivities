...
export default function ActivityDashboard ({activities, submitting, selectActivity,deleteActivity,  selectedActivity, cancelSelectActivity, openForm, closeForm, editMode, createOrEdit}: Props) {
    return (
        <Grid>
